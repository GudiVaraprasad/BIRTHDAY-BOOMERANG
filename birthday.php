...
<?php
  $query="select name,city,phone,gender,email, abs(year(current_date)-year(dob)) as age from birthdays where month(current_date)=month(dob) AND day(current_date)=day(dob)";
...
if(isset($_POST["submit1"]))
{
    ...
    $body="\n Wish you a very Happy Birthday \n\n \t\t- From Sri Harsha and Neha Chowdary.";
    $headers = "From: talasilasriharshachowdary@gmail.com";
