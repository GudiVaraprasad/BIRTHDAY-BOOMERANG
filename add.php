...
<br><br>
                                <div>
                                    ...
                                    <input type="text" name="phone" required pattern="[0-9]{10}" title="This field is required">
                                </div>
<br><br>
                                <div>
                                    <label>Email : </label>
...
if(isset($_POST["submit1"]))
{
    ...
    if ($count>0) {
        ...
        $sql="insert into birthdays values
            (NULL, '$_POST[name]', '$_POST[city]', '$_POST[dob]', '$_POST[gender]', '$_POST[phone]', '$_POST[email]')";
